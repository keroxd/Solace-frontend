...
const NavBar = () => {
    ...
    return (
        <>
            <div className="bg-black text-neutral-100 w-full h-12 z-50 px-15 fixed flex justify-center items-center">
                <section className="w-full flex items-center justify-between">
                    <h1 onClick={() => navigate("/")} className="font-mont text-sm font-medium cursor-pointer">SOLACE</h1>
